...
## 🚀 Getting Started: Download and Run dfm
...
### Step 2: Find the Windows Download
...
- Double-click the `.exe` file to start dfm.
- If you see a security warning, select "Run" or "Allow" to continue.
...
- Run the program as an administrator by right-clicking the `.exe` and selecting "Run as administrator."
